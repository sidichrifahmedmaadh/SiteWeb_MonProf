...
document.addEventListener('DOMContentLoaded', function() {
    ...
    onlineTab.addEventListener('click', function(event) {
        event.preventDefault();
        onlineTab.classList.add('active');
        inPersonTab.classList.remove('active');
        addressField.style.display = 'none';
    });

    inPersonTab.addEventListener('click', function(event) {
        event.preventDefault();
        inPersonTab.classList.add('active');
...
animateContent([".home .content h5, .home .content h1, .home .content p, .home .content .search-container"]);
